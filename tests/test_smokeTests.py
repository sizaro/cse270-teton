...
class TestSmokeTests():
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1206, 680)
    ...
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".myinput:nth-child(4)")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".myinput:nth-child(5)")
    assert len(elements) > 0
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("siza")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("siza123")
  ...
  def test_joinPage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1286, 680)
    self.driver.find_element(By.LINK_TEXT, "Join").click()
    elements = self.driver.find_elements(By.CSS_SELECTOR, ".myinput:nth-child(2)")
    assert len(elements) > 0
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Ronald")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Siza")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("siza soft tech")
